...
static var building_data: Dictionary[BuildingType, Resource] = {
	...
	BuildingType.BIOMASS_POWER_PLANT: load("res://resources/buildings/biomass_power_plant_building.tres"), 
	BuildingType.BIOMASS_LANDFILL: load("res://resources/buildings/biomass_landfill.tres"), 
	BuildingType.WAREHOUSE: load("res://resources/buildings/warehouse_building.tres"), 
